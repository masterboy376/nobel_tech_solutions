...
export default function Home() {
  return (
    <>
          ...
          <div className="container mx-auto flex px-2 py-2 md:py-24 md:flex-row flex-col items-center">
            ...
            <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
              ...
              <div className="flex w-full md:justify-start justify-center items-end">
                ...
                <button className="btn-primary py-2 px-6">Button</button>
              </div>
      ...
      {/* services */}
      <section id='service' className='section-container'>Services</section>

      {/* testimonials */}
      <section id='testimonial' className='section-container'>Testimonials</section>
